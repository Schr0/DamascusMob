...
public class ItemDamascusRod extends Item
{

	private static final int COOLDOWN_TIME = (3 * 20);

	public ItemDamascusRod()
	{
		this.maxStackSize = 1;
	...
	public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase entityLiving)
	{
		if ((entityLiving.getActiveHand() == EnumHand.MAIN_HAND) && (entityLiving.getRidingEntity() instanceof EntityDamascus))
		{
			...
			Vec3d ownerLookVec = entityDamascus.getLookVec();
			...
			worldIn.playEvent((EntityPlayer) null, 1016, entityDamascus.getPosition(), 0);
